...
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp kcghbonds.f
...
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp usolve.f
...
ifort -c -O3 -xHost -debug full -no-ipo -no-prec-div -openmp ecghbond.f
ifort -c -O3 -xHost -debug full -no-ipo -no-prec-div -openmp ecghbond1.f
ifort -c -O3 -xHost -debug full -no-ipo -no-prec-div -openmp ecghbond2.f
ifort -c -O3 -xHost -debug full -no-ipo -no-prec-div -openmp ecghbond3.f
...
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp kcghbond.f
