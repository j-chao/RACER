...
c
c ##### Commented 01/02/17 by David ######
c      else if (keyword(1:7) .eq. 'CGHBOND') then
c         use_cghbond = .true.
c         read (string,*,err=10,end=10)  ehbmax,hbondmin,cghbondcutoff
...
c     ########## added by David #################
      else if (keyword(1:13) .eq. 'DEBYE-LENGTH ') then
         read (string,*,err=10,end=10)  kdebyescreen
c     #########################################      
